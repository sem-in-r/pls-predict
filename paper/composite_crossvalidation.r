...
semData=read.csv("data/composite.csv",header=T)
...
mmMatrix <- matrix(c("LV1","x11","F",
                     ...
                     "LV3","x32","R",
                     "LV3","x33","R",
                     "LV3","x34","R"),nrow=12,ncol=3,byrow =TRUE,
...
graphCombinedResiduals("x31",lm.residuals,pls.residuals ,paste(title,"Y1"),xrange,yrange,10,"LM","PLS",xcolor,ycolor)
graphCombinedResiduals("x32",lm.residuals,pls.residuals ,paste(title,"Y2"),xrange,yrange,10,"LM","PLS",xcolor,ycolor)
graphCombinedResiduals("x33",lm.residuals,pls.residuals ,paste(title,"Y3"),xrange,yrange,10,"LM","PLS",xcolor,ycolor)
graphCombinedResiduals("x34",lm.residuals,pls.residuals ,paste(title,"Y4"),xrange,yrange,10,"LM","PLS",xcolor,ycolor)
